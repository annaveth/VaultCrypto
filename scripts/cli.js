...
const contractABI = require("../artifacts/contracts/Vaultcrypto.sol/Vaultcrypto.json").abi;

program
    .name("vaultcrypto-cli")
    .description("CLI tool for Vaultcrypto smart contract")
    .version("1.0.0");
